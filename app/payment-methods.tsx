...
export default function PaymentMethodsScreen() {
  ...
  React.useEffect(() => {
    console.log('[payment-methods] mounted. closeOnAdd=', params.closeOnAdd, 'returnTo=', params.returnTo);
  }, [params.closeOnAdd, params.returnTo]);

  React.useEffect(() => {
    console.log('[payment-methods] paymentMethods changed:', paymentMethods.length);
  ...
  const handleAddPaymentMethod = async () => {
    console.log('[payment-methods] handleAddPaymentMethod start. type=', selectedType);
